...
void Page::updateSide(){
    ...
    musicVolume.bounds = {setting_menu.x + setting_menu.width * 0.4f, setting_menu.y + setting_menu.width*0.3f * 0.61f + 10, setting_menu.width*0.5f, setting_menu.width*0.3f * 0.61f};
}
...
void Page::init() {
    ...
    Slider musicVolume  = Slider({setting_menu.x + setting_menu.width * 0.4f, setting_menu.y + setting_menu.width*0.3f * 0.61f + 5, setting_menu.width*0.5f, setting_menu.width*0.3f * 0.61f}, 0, 1);
